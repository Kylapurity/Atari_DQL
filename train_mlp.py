...
Original file is located at
    https://colab.research.google.com/drive/1NvobVI8cU2VtI4Ervr22C_VmUF_nwSZd
"""
...
print(f"\nBest model: {best_model_name} with mean reward {best_result['mean_reward']:.2f}")

# Save the best model as the final model to use
for model in trained_models:
    if model.__dict__.get('name', '') == best_model_name:
        model.save("dqn_assault_best")
        break
